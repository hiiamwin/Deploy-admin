    ...
    downloadIngredientFileAction,
    {
      onSuccess: ({ data }) => {
        if (data) {
          ...
          link.href = url;
          link.setAttribute("download", "ingredient.xlsx");
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpen}>
      <DialogTrigger asChild>
        <Button>Thêm số lượng nguyên liệu</Button>
      </DialogTrigger>
      <DialogContent className="bg-white">
        <DialogHeader>
          <DialogTitle>Thêm số lượng nguyên liệu</DialogTitle>
          <DialogDescription>
            Vui lòng tải xuống file mẫu và nhập vào file số lượng nguyên liệu
          </DialogDescription>
        </DialogHeader>
...
export default AddIngerdientDialog;
