...
import { getRestaurantAction, getTopUnpopularDishAction } from "@/actions";
import { ScrollArea } from "@/components/ui/scroll-area";

function TopUnpopularDishAdmin() {
  ...
  const { data, isFetching } = useQuery({
    queryKey: [
      ...
      { timeFrame: period, date: date, resId },
    ],
    queryFn: () =>
...
export default TopUnpopularDishAdmin;
