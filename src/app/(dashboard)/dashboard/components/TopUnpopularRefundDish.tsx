...
import { getTopUnpopularRefundDishAction } from "@/actions";
import { ScrollArea } from "@/components/ui/scroll-area";

function TopUnpopularRefundDish({ restaurantId }: { restaurantId: string }) {
      ...
      <CardHeader className="flex flex-row items-center pb-2 space-y-0 justify-center">
        <CardTitle>
          <div className="text-xl font-bold  flex items-center gap-2 justify-center">
            Top 10 món ăn hoàn tiền bán ít nhất
...
export default TopUnpopularRefundDish;
