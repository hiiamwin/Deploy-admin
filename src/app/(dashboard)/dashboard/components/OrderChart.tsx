...
import { getOrderStatisticAction, getRestaurantAction } from "@/actions";
import { ChevronLeft, ChevronRight, Loader2 } from "lucide-react";

function OrderChart({ role }: { role: string }) {
  /**
   * 0: week
   * 1: month
   * 2: year
  ...
  const { data, isFetching } = useQuery({
    queryKey: ["getOrderStatistic", { timeFrame: period, date, resId: res }],
    queryFn: () =>
