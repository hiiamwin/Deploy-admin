...
import UpdateIngredientGeneralDialog from "./UpdateIngredientGeneralDialog";
import InactiveIngredientGeneralDialog from "./InactiveIngredientGeneralDialog";
import ActiveIngredientGeneral from "./ActiveIngredientGeneral";

function IngredientGeneralMenuActions({ item }: { item: IngredientGeneral }) {
  ...
  return (
    <>
      ...
      {isOpenInactivateDialog && (
        <InactiveIngredientGeneralDialog
          id={item.id}
...
export default IngredientGeneralMenuActions;
